...
![image-20200704111417472](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205111428226.png)
...
![image-20200704112119729](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205111428888.png)
...
![image-20200704112700211](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205111429796.png)

垃圾收集机制为我们打理了很多繁琐的工作，大大提高了开发的效率，但是，垃圾收集也不是万能的，懂得 JVM 内部的内存结构、工作机制，是设计高扩展性应用和诊断运行时问题的基础，也是 Java 工程师进阶的必备能力。

## 1.2. 面向人群及参考书目

![image-20210507095948516](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205111437714.png)

![image-20200704145340513](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205111437738.png)

![image-20210507100021400](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205111437976.png)

![image-20210507100104455](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205111437505.png)

## 1.3. Java 及 JVM 简介

**TIOBE 语言热度排行榜：[index | TIOBE - The Software Quality Company](https://gitee.com/link?target=https%3A%2F%2Ftiobe.com%2Ftiobe-index%2F)**
...
![image-20200704151731216](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205111442086.png)

每个语言都需要转换成字节码文件，最后转换的字节码文件都能通过 Java 虚拟机进行运行和处理

![image-20200704152052489](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205111442663.png)
...
![image-20210507102334642](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205111504489.png)
...
![image-20200704182035810](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205111502430.png)
...
![img](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205111516466.png)
...
![image-20200704183048061](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205111521869.png)

JVM 是运行在操作系统之上的，它与硬件没有直接的交互 ![image-20210507104030823](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205111521008.png)

## 1.6. JVM 的整体结构

![image-20200704183436495](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205111525180.png)
...
![image-20200704210429535](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205111527317.png)
...
- 目前 **Hotspot 占有绝对的市场地位，称霸武林。**
  ...
  - 因此本文默认介绍的虚拟机都是 HotSpot，相关机制也主要是指 HotSpot 的 Gc 机制。（比如其他两个商用虚机都没有方法区的概念）
- 从服务器、桌面到移动端、嵌入式都有应用。
...
- 前面三大“高性能 Java 虚拟机”使用在通用硬件平台上这里 Azul VW 和 BEA Liquid VM 是**与特定硬件平台绑定、软硬件配合的专有虚拟机**
  - 高性能 Java 虚拟机中的战斗机。
...
![image-20200705080719531](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205111656906.png)

![image-20200705080911284](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205111656026.png)
...
![image-20200705081813409](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205111700474.png)
...
![image-20200705081913538](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205130840452.png)
...
![image-20200705082255746](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205130844499.png)

### 加载阶段

![image-20200705082601441](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205130845088.png)
...
![image-20200705094149223](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205130941065.png)
...
3. 在编写自定义类加载器 时，如果没有太过于复杂的需求，可以直接继承 URLClassLoader 类，这样就可以避免自己去编写 findClass() 方法及其获取字节码流的方式，使自定义类加载器编写更加简洁。

## 2.4. ClassLoader 的使用说明

ClassLoader 类是一个抽象类，其后所有的类加载器都继承自 ClassLoader（不包括启动类加载器）

![image-20200705103516138](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131003636.png)

sun.misc.Launcher 它是一个 java 虚拟机的入口应用

![image-20200705103636003](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131003538.png)
...
![image-20200705105151258](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131003062.png)
...
![image-20200705105810107](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131003808.png)
...
![image-20200705111640511](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131609002.png)

当我们通过前面的：类的加载-> 验证 -> 准备 -> 解析 -> 初始化 这几个阶段完成后，就会用到执行引擎对我们的类进行使用，同时执行引擎将会使用到我们运行时数据区

![image-20200705111843003](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131609012.png)
...
![image-20210509174724223](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131609605.png)

我们把大厨后面的东西（切好的菜，刀，调料），比作是运行时数据区。而厨师可以类比于执行引擎，将通过准备的东西进行制作成精美的菜品

![image-20210509174543026](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131609667.png)

我们通过磁盘或者网络 IO 得到的数据，都需要先加载到内存中，然后 CPU 从内存中获取数据进行读取，也就是说内存充当了 CPU 和磁盘之间的桥梁

![image-20200705112416101](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131612933.png)
...
![image-20200705112601211](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131613226.png)

每个 JVM 只有一个 Runtime 实例。即为运行时环境，相当于内存结构的中间的那个框框：运行时环境。

![image-20210509173410373](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131613793.png)
...
![image-20200705155551919](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131613356.png)

**作用**

PC 寄存器用来存储指向下一条指令的地址，也即将要执行的指令代码。由执行引擎读取下一条指令。

![image-20200705155728557](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131613186.png)
...
![image-20200705161409533](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131613735.png)
...
![image-20200705161849557](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131613739.png)
...
![image-20200705163928652](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131613146.png)
...
![image-20200705165025382](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131613616.png)
...
![image-20200705203142545](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131613046.png)
...
![image-20200705204836977](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131613219.png)

并行每个线程下的栈都是私有的，因此每个线程都有自己各自的栈，并且每个栈里面都有很多栈帧，栈帧的大小主要由局部变量表 和 操作数栈决定的

![image-20200705205443993](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131613491.png)
...
![image-20200705212454445](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131613323.png)
...
![image-20200706090618332](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131613890.png)
...
![image-20200706093131621](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131613260.png)

![image-20200706093251302](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131613641.png)

![image-20200706093646406](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131614285.png)

![image-20200706093751711](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131614797.png)

![image-20200706093859191](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131614501.png)

![image-20200706093921573](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131614385.png)

![image-20200706094046782](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131614770.png)

![image-20200706094109629](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131614538.png)
...
![image-20200706101251847](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205131614287.png)
...
![image-20200706144954070](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141319838.png)
...
![image-20210509203351535](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141319691.png)
...
![image-20200706164139252](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141319381.png)
...
![image-20200706174708418](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141320005.png)
...
![image-20200706195127740](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141512515.png)
...
![image-20200706201904057](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141512168.png)
...
![image-20200706203419496](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141512065.png)

### 6.1.3. 堆空间内部结构（JDK8）

![image-20200706203835403](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141512417.png)
...
- “-Xms(-x 是jvm的运行参数	ms 是memory start)"用于表示堆区的起始内存，等价于`-XX:InitialHeapSize`
...
![image-20200707075847954](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141512841.png)

下面这参数开发中一般不会调：

![image-20200707080154039](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141512870.png)
...
![image-20210510105849497](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141512034.png)
...
![第08章_新生代对象分配与回收过程](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141512293.jpeg)

**流程图**

![image-20200707091058346](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141512665.png)
...
![image-20200707095606813](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141512094.png)
...
![image-20200707101511025](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141512480.png)

其实不分代完全可以，分代的**唯一理由就是优化 GC 性能**。如果没有分代，那所有的对象都在一块，就如同把一个学校的人都关在一个教室。GC 的时候要找到哪些对象没用，这样就会对堆的所有区域进行扫描。而很多对象都是朝生夕死的，如果分代的话，把新创建的对象放到某一地方，当 GC 的时候先把这块存储“朝生夕死”对象的区域进行回收，这样就会腾出很大的空间出来。

![image-20200707101543871](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141512568.png)
...
![image-20210510114110526](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141512018.png)
...
![image-20200707104253530](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141512506.png)
...
![image-20210510141044840](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141513670.png)

从线程共享与否的角度来看

![image-20210510141131860](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141513305.png)

## 7.1. 栈、堆、方法区的交互关系

![image-20200708094747667](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141513274.png)

## 7.2. 方法区的理解

官方文档：[Chapter 2. The Structure of the Java Virtual Machine (oracle.com)](https://gitee.com/link?target=https%3A%2F%2Fdocs.oracle.com%2Fjavase%2Fspecs%2Fjvms%2Fse8%2Fhtml%2Fjvms-2.html%23jvms-2.5.4)

![image-20210510195446194](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141513691.png)
...
![image-20200708095853544](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141513529.png)
...
![image-20210510142516373](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141513726.png)
...
![image-20210510142656677](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141513631.png)

而到了 JDK8，终于完全废弃了永久代的概念，改用与 JRockit、J9 一样在本地内存中实现的元空间（Metaspace）来代替

![image-20200708103055914](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141513438.png)
...
![image-20200708111756800](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141513499.png)
...
![image-20210510143959924](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141513658.png)
...
![image-20200708161728320](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141513342.png)
...
![image-20200708161856504](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141513735.png)
...
![image-20200708171151384](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141513760.png)
...
官方文档：[https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-4.html](https://gitee.com/link?target=https%3A%2F%2Fdocs.oracle.com%2Fjavase%2Fspecs%2Fjvms%2Fse8%2Fhtml%2Fjvms-4.html)

![image-20200708172357052](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141513450.png)
...
![image-20210510145947122](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141513103.png)
...
![image-20210510151436251](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141513060.png)

![image-20210510151504259](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205181515799.png)

![image-20210510151520952](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141513855.png)
...
![image-20210510151829404](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141514043.png)

![image-20210510151918342](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141514954.png)

![image-20210510151951327](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141514850.png)

![image-20200708205708057](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141514289.png)

![image-20210510152102989](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141514492.png)

![image-20210510152138492](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141514917.png)

![image-20210510195824437](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141514607.png)

![image-20210510195911639](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141514568.png)

![image-20210510152243933](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141514304.png)
...
![image-20200708211541300](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191812213.png)

![image-20200708211609911](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141514223.png)

![image-20200708211637952](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141514016.png)

### 7.6.1. 为什么永久代要被元空间替代？

官网地址：[JEP 122: Remove the Permanent Generation (java.net)](https://gitee.com/link?target=http%3A%2F%2Fopenjdk.java.net%2Fjeps%2F122)

![image-20210510163843564](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141514646.png)
...
![image-20200708215218078](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141514186.png)

staticobj 随着 Test 的类型信息存放在方法区，instanceobj 随着 Test 的对象实例存放在 Java 堆，localobject 则是存放在 foo()方法栈帧的局部变量表中。

![image-20200708215025527](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141514579.png)
...
![image-20200708220303243](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141515541.png)
...
![image-20200709095356247](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141515428.png)
...
![image-20210510220743192](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141515443.png)
...
![image-20200709151033237](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141515294.png)
...
![image-20200709152801713](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141515519.png)

### 小结

![image-20210510225407119](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141515189.png)

## 8.3. 对象的访问定位

![image-20210510230045654](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141515233.png)

JVM 是如何通过栈帧中的对象引用访问到其内部的对象实例呢？

![image-20200709164149920](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141515864.png)

### 8.3.1. 句柄访问

![image-20210510230241991](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141515837.png)

reference 中存储稳定句柄地址，对象被移动（垃圾收集时移动对象很普遍）时只会改变句柄中实例数据指针即可，reference 本身不需要被修改

### 8.3.2. 直接指针（HotSpot 采用）

![image-20210510230337956](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141515747.png)
...
![image-20210510231408607](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141515285.png)

### 8.4.3. 直接缓存区

使用 NIO 时，操作系统划出的直接缓存区可以被 java 代码直接访问，只有一份。NIO 适合对大文件的读写操作。

![image-20210510231456550](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141515244.png)
...
![image-20200709230647277](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141515568.png)
...
![image-20200710080707873](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205141515062.png)
...
![image-20200710081627217](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205161437897.png)

从外观上来看，所有的 Java 虚拟机的执行引擎输入，输出都是一致的：输入的是字节码二进制流，处理过程是字节码解析执行的等效过程，输出的是执行过程。

## 9.2. Java 代码编译和执行过程

![image-20200710082141643](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205161437234.png)

大部分的程序代码转换成物理机的目标代码或虚拟机能执行的指令集之前，都需要经过上图中的各个步骤

Java 代码编译是由 Java 源码编译器（前端编译器）来完成，流程图如下所示：

![image-20200710082433146](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205161437251.png)

Java 字节码的执行是由 JVM 执行引擎（后端编译器）来完成，流程图 如下所示

![image-20200710083036258](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205161437022.png)
...
![image-20200710083656277](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205161437440.png)
...
![image-20200710085323733](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191812026.png)
...
![image-20200710085553258](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205161437962.png)
...
![image-20210511092336091](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191812330.png)

## 9.4. 解释器

JVM 设计者们的初衷仅仅只是单纯地为了满足 Java 程序实现跨平台特性，因此避免采用静态编译的方式直接生成本地机器指令，从而诞生了实现解释器在运行时采用逐行解释字节码执行程序的想法。

![image-20200710090203674](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205161438197.png)
...
![image-20200710095417462](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205161438742.png)
...
![image-20200710101829934](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205161438547.png)
...
![image-20200710103103869](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205161438933.png)
...
官网地址：[JEP 254: Compact Strings (java.net)](https://gitee.com/link?target=http%3A%2F%2Fopenjdk.java.net%2Fjeps%2F254)
...
![image-20200711093546398](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205161438124.png)

![image-20200711093558709](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205161438201.png)

**StringTable 为什么要调整？**

官网地址：[Java SE 7 Features and Enhancements (oracle.com)](https://gitee.com/link?target=https%3A%2F%2Fwww.oracle.com%2Fjava%2Ftechnologies%2Fjavase%2Fjdk7-relnotes.html%23jdk7changes)
...
![image-20210511111607132](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205161438350.png)
...
- 使用 final 修饰，即为常量。会在编译器进行代码优化。在实际开发中，能够使用 f inal 的，尽量使用
...
>
> When the intern method is invoked, if the pool already contains a string equal to this `String` object as determined by the [`equals(Object)`](https://gitee.com/link?target=https%3A%2F%2Fdocs.oracle.com%2Fjavase%2F8%2Fdocs%2Fapi%2Fjava%2Flang%2FString.html%23equals-java.lang.Object-) method, then the string from the pool is returned. Otherwise, this `String` object is added to the pool and a reference to this `String` object is returned.
>
...
![image-20210511145542579](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205161438529.png)
...
![image-20210511152240683](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205161438162.png)

![image-20200711145925091](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205161438917.png)
...
![image-20200711150859709](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205161438417.png)

![image-20200711151326909](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205161439253.png)

**练习 2**

![image-20200711151433277](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205161439154.png)
...
```
[GC (Allocation Failure) [PSYoungGen: 4096K->504K(4608K)] 4096K->768K(15872K), 0.0016919 secs] [Times: user=0.00 sys=0.00, real=0.00 secs] 
Heap
 PSYoungGen      total 4608K, used 3906K [0x00000000ffb00000, 0x0000000100000000, 0x0000000100000000)
  eden space 4096K, 83% used [0x00000000ffb00000,0x00000000ffe52968,0x00000000fff00000)
  from space 512K, 98% used [0x00000000fff00000,0x00000000fff7e030,0x00000000fff80000)
  to   space 512K, 0% used [0x00000000fff80000,0x00000000fff80000,0x0000000100000000)
 ParOldGen       total 11264K, used 264K [0x00000000ff000000, 0x00000000ffb00000, 0x00000000ffb00000)
  object space 11264K, 2% used [0x00000000ff000000,0x00000000ff042000,0x00000000ffb00000)
 Metaspace       used 3340K, capacity 4496K, committed 4864K, reserved 1056768K
  class space    used 358K, capacity 388K, committed 512K, reserved 1048576K
SymbolTable statistics:
Number of buckets       :     20011 =    160088 bytes, avg   8.000
Number of entries       :     13696 =    328704 bytes, avg  24.000
Number of literals      :     13696 =    586744 bytes, avg  42.841
Total footprint         :           =   1075536 bytes
Average bucket size     :     0.684
Variance of bucket size :     0.685
Std. dev. of bucket size:     0.828
Maximum bucket size     :         6
StringTable statistics:
Number of buckets       :     60013 =    480104 bytes, avg   8.000
Number of entries       :     62827 =   1507848 bytes, avg  24.000
Number of literals      :     62827 =   3576616 bytes, avg  56.928
Total footprint         :           =   5564568 bytes
Average bucket size     :     1.047
Variance of bucket size :     0.822
Std. dev. of bucket size:     0.907
Maximum bucket size     :         5
```

## 10.7. G1 中的 String 去重操作

官网地址：[JEP 192: String Deduplication in G1 (java.net)](https://gitee.com/link?target=http%3A%2F%2Fopenjdk.java.net%2Fjeps%2F192)
...
![image-20200712085456113](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205171334519.png)
...
oracle 官网关于垃圾回收的介绍 [https://docs.oracle.com/javase/8/docs/technotes/guides/vm/gctuning/toc.html](https://gitee.com/link?target=https%3A%2F%2Fdocs.oracle.com%2Fjavase%2F8%2Fdocs%2Ftechnotes%2Fguides%2Fvm%2Fgctuning%2Ftoc.html)
...
![image-20200712092427246](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/c3e4606c5878ad5ae19f878e2585ee9f.png)
...
![image-20200712102205795](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191808787.png)
...
![image-20200712103230349](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191808738.png)
...
![image-20210511195540451](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191809499.png)
...
![image-20200712104622677](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191809614.png)
...
大家可以在 [http://www.eclipse.org/mat/](https://gitee.com/link?target=http%3A%2F%2Fwww.eclipse.org%2Fmat%2F) 下载并使用 MAT

#### 获取 dump 文件

##### 方式一：命令行使用 jmap

![image-20210512105418987](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191809284.png)
...
![image-20200712112512720](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191809833.png)

#### JProfiler 的 GC Roots 溯源

我们在实际的开发中，一般不会查找全部的 GC Roots，可能只是查找某个对象的整个链路，或者称为 GC Roots 溯源，这个时候，我们就可以使用 JProfiler

![image-20200712113256075](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191809977.png)
...
![image-20200712150935078](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191809949.png)
...
![image-20200712151916991](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191812683.png)
...
![image-20200712152847218](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191809865.png)
...
![image-20200712153236508](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191809623.png)
...
![image-20210512104415281](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191809511.png)
...
![image-20200712165318590](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191809242.png)
...
![image-20200712195158470](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191809238.png)
...
![image-20200712202522051](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191809393.png)
...
![image-20200712202822129](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191809080.png)
...
![image-20210512112822896](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191809534.png)

#### 并发（Concurrent）

指用户线程与垃圾收集线程同时执行（但不一定是并行的，可能会交替执行），垃圾回收线程在执行时不会停顿用户程序的运行。用户程序在继续运行，而垃圾收集程序线程运行于另一个 CPU 上；如：CMS、G1

![image-20200712203815517](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191809804.png)
...
.![image-20200712205813321](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191809498.png)
...
![image-20200712211501377](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191809850.png)
...
![image-20200712211732976](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191809893.png)
...
![image-20210512144253383](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191810910.png)
...
![image-20200713083443486](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191810230.png)
...
![image-20200713084726176](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191810388.png)
...
![image-20200713085306400](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191810623.png)
...
![image-20200713093757644](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191810805.png)
...
![image-20200713094745366](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191810821.png)
...
![image-20200713100703799](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191810124.png)
...
![image-20200713102030127](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191810345.png)
...
![image-20200713110359441](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191810850.png)
...
![image-20200713205154007](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191810060.png)
...
![image-20200713212230352](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191810989.png)
...
![image-20200713215105293](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191810062.png)

![image-20200713215133839](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191810597.png)
...
![image-20200713223244886](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191810359.png)
...
![image-20200713223509993](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191810984.png)
...
![image-20200713224113996](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191810945.png)
...
![image-20200713224716715](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191810179.png)
...
![image-20200713225100632](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191810440.png)
...
![image-20200713225810871](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191811100.png)
...
![image-20200714080151020](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191811040.png)
...
![image-20200714082555688](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191811495.png)

### Full GC 日志

![image-20210512194815354](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191811224.png)
...
![image-20200714083332238](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191811980.png)

![image-20200714083526790](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191811444.png)
...
Epsilon:A No-Op GarbageCollector（Epsilon 垃圾回收器，"No-Op（无操作）"回收器）[http://openidk.iava.net/jeps/318](https://gitee.com/link?target=http%3A%2F%2Fopenidk.iava.net%2Fjeps%2F318)

ZGC:A Scalable Low-Latency Garbage Collector（Experimental）（ZGC：可伸缩的低延迟垃圾回收器，处于实验性阶段）[http://openidk.iava.net/jeps/333](https://gitee.com/link?target=http%3A%2F%2Fopenidk.iava.net%2Fjeps%2F318)

![image-20210512195426194](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191811010.png)
...
![image-20200714090608807](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191811325.png)
...
[http://www.atguigu.com/download_detail.shtml?v=222](https://gitee.com/link?target=http%3A%2F%2Fwww.atguigu.com%2Fdownload_detail.shtml%3Fv%3D222)

或

[https://www.bilibili.com/video/BV1jJ411M7kQ?from=search&seid=12339069673726242866](https://gitee.com/link?target=https%3A%2F%2Fwww.bilibili.com%2Fvideo%2FBV1jJ411M7kQ%3Ffrom%3Dsearch%26seid%3D12339069673726242866)

### 13.X.3. 令人震惊、革命性的 ZGC

官方地址：[https://docs.oracle.com/en/java/javase/12/gctuning/](https://gitee.com/link?target=https%3A%2F%2Fdocs.oracle.com%2Fen%2Fjava%2Fjavase%2F12%2Fgctuning%2F)

![image-20210512200236647](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191811431.png)
...
![image-20200714091201073](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191811626.png)

![image-20200714091401511](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191811008.png)
...
![image-20200714093243028](https://chenfl-note.oss-cn-hangzhou.aliyuncs.com/note/java/jvm/img/202205191811431.png)
